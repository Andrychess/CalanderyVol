...
Карточки мероприятий хранятся в [JsonBox.ru](https://jsonbox.ru) в формате JSON. Редактирование доступно руководителю сообщества VK (админ / редактор / модератор).
...
Открывайте mini app **из сообщества**, чтобы определялся `vk_group_id` и права руководителя.
...
| `js/vk-auth.js` | VK Bridge и проверка роли |
